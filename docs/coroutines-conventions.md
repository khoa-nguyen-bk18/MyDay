...
| **data** | Caller-scoped only (no `GlobalScope`) | Injected via [DispatcherProvider](../data/src/commonMain/kotlin/com/devindie/myday/data/coroutines/DispatcherProvider.kt) | Main-safe `suspend`; `withContext(provider.io)` for blocking I/O |
...
- **Do** bind [AndroidDispatcherProvider](../data/src/androidMain/kotlin/com/devindie/myday/data/coroutines/AndroidDispatcherProvider.kt) / [IosDispatcherProvider](../data/src/iosMain/kotlin/com/devindie/myday/data/coroutines/IosDispatcherProvider.kt) in [platformDataModule](../data/src/commonMain/kotlin/com/devindie/myday/data/di/PlatformDataModule.kt) actuals.
...
See [RunDataTest.kt](../data/src/commonTest/kotlin/com/devindie/myday/data/coroutines/RunDataTest.kt) and [TestDispatcherProvider.kt](../data/src/commonTest/kotlin/com/devindie/myday/data/coroutines/TestDispatcherProvider.kt).
...
See [RunViewModelTest.kt](../shared/src/commonTest/kotlin/com/devindie/myday/test/RunViewModelTest.kt). Use `advanceTimeBy` for debounced flows (e.g. browse search). Prefer [Turbine](https://github.com/cashapp/turbine) when asserting multiple `StateFlow` / event emissions.
