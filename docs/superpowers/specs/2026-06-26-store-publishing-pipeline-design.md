...
Add a `store/` directory and supporting scripts, Fastlane lanes, and GitHub Actions workflows so every app generated from myday-template can:
...
app:
  displayName: "MyDay"
  androidPackage: "com.devindie.myday"
  iosBundleId: "com.devindie.myday"
...
When codegen creates a new app from myday-template:
