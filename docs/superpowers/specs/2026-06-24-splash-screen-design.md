...
- App name "MyDay" — `headlineSmall`, `onBackground`
...
- `Theme.MyDay.Splash` — `Theme.SplashScreen`, background `#F9F9FF`, `postSplashScreenTheme = Theme.MyDay`
- `Theme.MyDay` — post-splash app theme
