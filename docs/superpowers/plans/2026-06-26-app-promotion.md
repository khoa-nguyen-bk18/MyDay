...
**Files:**
- Create: `shared/src/commonMain/kotlin/com/devindie/myday/feature/apppromotion/api/AppPromotionResult.kt`
- Create: `shared/src/commonMain/kotlin/com/devindie/myday/feature/apppromotion/api/AppPromotionConfig.kt`
- Create: `shared/src/commonMain/kotlin/com/devindie/myday/feature/apppromotion/api/AppPromotionClient.kt`
...
```bash
git add shared/src/commonMain/kotlin/com/devindie/myday/feature/apppromotion/api/
...
**Files:**
- Create: `shared/src/commonMain/kotlin/com/devindie/myday/feature/apppromotion/impl/platform/AppPromotionPlatform.kt`
- Create: `shared/src/commonMain/kotlin/com/devindie/myday/feature/apppromotion/impl/NoOpAppPromotionClient.kt`
- Create: `shared/src/commonMain/kotlin/com/devindie/myday/feature/apppromotion/impl/AppPromotionClientImpl.kt`
- Test: `shared/src/commonTest/kotlin/com/devindie/myday/feature/apppromotion/impl/AppPromotionClientImplTest.kt`
...
Run: `./gradlew :shared:iosSimulatorArm64Test --tests "com.devindie.myday.feature.apppromotion.impl.AppPromotionClientImplTest"`
...
```bash
git add shared/src/commonMain/kotlin/com/devindie/myday/feature/apppromotion/impl/ \
        shared/src/commonTest/kotlin/com/devindie/myday/feature/apppromotion/
...
**Files:**
- Create: `shared/src/androidMain/kotlin/com/devindie/myday/feature/apppromotion/impl/platform/AndroidAppPromotionPlatform.kt`
- Create: `shared/src/androidMain/kotlin/com/devindie/myday/feature/apppromotion/impl/platform/AppPromotionPlatformModule.android.kt`
- Create: `shared/src/commonMain/kotlin/com/devindie/myday/feature/apppromotion/impl/platform/AppPromotionPlatformModule.kt`
...
```bash
git add shared/src/androidMain/kotlin/com/devindie/myday/feature/apppromotion/
git add shared/src/commonMain/kotlin/com/devindie/myday/feature/apppromotion/impl/platform/AppPromotionPlatformModule.kt
...
**Files:**
- Create: `shared/src/iosMain/kotlin/com/devindie/myday/feature/apppromotion/impl/platform/IosAppPromotionPlatform.kt`
- Create: `shared/src/iosMain/kotlin/com/devindie/myday/feature/apppromotion/impl/platform/AppPromotionPlatformModule.ios.kt`
...
```bash
git add shared/src/iosMain/kotlin/com/devindie/myday/feature/apppromotion/
...
**Files:**
- Create: `shared/src/commonMain/kotlin/com/devindie/myday/feature/apppromotion/api/AppPromotionFeatureModule.kt`
- Create: `shared/src/commonMain/kotlin/com/devindie/myday/apppromotion/AppPromotionDefaults.kt`
...
```bash
git add shared/src/commonMain/kotlin/com/devindie/myday/feature/apppromotion/api/AppPromotionFeatureModule.kt \
        shared/src/commonMain/kotlin/com/devindie/myday/apppromotion/ \
...
**Files:**
- Create: `shared/src/commonMain/kotlin/com/devindie/myday/feature/apppromotion/api/AppPromotionActions.kt`
- Create: `shared/src/commonMain/kotlin/com/devindie/myday/feature/apppromotion/api/AppPromotionSettingsSection.kt`
...
```bash
git add shared/src/commonMain/kotlin/com/devindie/myday/feature/apppromotion/api/AppPromotionActions.kt \
        shared/src/commonMain/kotlin/com/devindie/myday/feature/apppromotion/api/AppPromotionSettingsSection.kt
...
**Files:**
- Modify: `shared/src/commonMain/kotlin/com/devindie/myday/feature/settings/impl/SettingsContent.kt`
...
```bash
git add shared/src/commonMain/kotlin/com/devindie/myday/feature/settings/impl/SettingsContent.kt
...
**Files:**
- Create: `shared/src/commonTest/kotlin/com/devindie/myday/fake/FakeAppPromotionClient.kt`
- Create: `shared/src/commonMain/kotlin/com/devindie/myday/feature/apppromotion/api/README.md`
...
```bash
git add shared/src/commonTest/kotlin/com/devindie/myday/fake/FakeAppPromotionClient.kt \
        shared/src/commonMain/kotlin/com/devindie/myday/feature/apppromotion/api/README.md
