package com.devindie.myday.architecture.packages
...
class PackageStructureTest {
    ...
    fun `domain production code lives under com devindie cmp templatedomain`() {
        val packages = Konsist.scopeFromPackage("com.devindie.myday.domain..").packages
    ...
    fun `repository contracts in domain repository are interfaces`() {
        junitAssertTrue(
            Konsist.scopeFromPackage("com.devindie.myday.domain.repository..")
                .interfaces()
    ...
    fun `RepositoryImpl classes live in data package`() {
        Konsist.scopeFromProject()
            ...
            .assertTrue { it.resideInPackage("com.devindie.myday.data..") }
    }
    ...
    fun `use case classes end with UseCase`() {
        ...
        Konsist.scopeFromProduction()
            .classes()
            .filter { it.resideInPackage("com.devindie.myday.domain.usecase..") }
